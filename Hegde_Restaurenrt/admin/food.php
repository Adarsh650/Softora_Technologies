...
<div class="content">
   ...
   <tr align="center">   
   	    ...
   	    <td >  
   	    	<select class="text" name="cat" onchange="showUser(this.value)" style="background-color: #ccc; color: black;">
			   <option >Select Category</option>
   	    		<option value="kathiyawadi">South Indian</option>
   	    		<option value="rajsthani">North Indian</option>
   	   ...
   	   <tr align="center">
   	   	    <td> Enter Title</td>
   	   	    <td><input type="text" name="title" value="" placeholder="" class="text" required style="background-color: #ccc; color: black;"></td>
   	   </tr> 
	<tr align="center"> 
            <td> Enter Food Detail </td>
			<td><textarea rows="4" name="detail" cols="40" class="ar" style="background-color: #ccc; color: black; padding: 10px;"></textarea></td>
	</tr>

	<tr align="center"> 
            <td> Enter Food Price </td>
			<td> <input type="text" name="price" class="text" style="background-color: #ccc; color: black;"> </td>
	</tr>

...
<div class="content">
   ...
   <tr align="center">   
   	    <td> 
   	    	<select class="text" name="cat" style="background-color: #ccc; color: black;">
	...
	<tr align="center">
			<td><input type="text" name="scat" value="" placeholder="Food Name" class="text" required style="background-color: #ccc; color: black;"></td>
	</tr>
	<tr align="center">
